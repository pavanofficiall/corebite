  ...
  return (
    <View>
      <ScrollView className={clsx(colors.background, "h-screen px-6")}>
        {/* Page Title */}
        <Text
          className={clsx(colors.accent, "font-semibold text-3xl mt-9 mb-5")}
        >
          Analytics
        </Text>
        ...
        <View className={clsx(colors.card, "rounded-md p-3 mb-6")}>
          <Text className={clsx(colors.text, "font-semibold text-lg mb-4")}>
            Weekly Progress
          </Text>
          <LineChart
            data={{
        ...
        <View
          className={clsx(
            colors.card,
            "w-full h-28 rounded-md p-5 mb-5 flex-row items-center"
          )}
        >
          <MaterialIcons name="fitness-center" size={28} color="#ceff00" />
          <View className="ml-3">
            <Text className={clsx(colors.text, "text-lg font-semibold")}>
              Workout Summary
            </Text>
        ...
        <View
          className={clsx(
            colors.card,
            "w-full h-28 rounded-md p-5 flex-row items-center"
          )}
        >
      ...
      {/* Floating Button */}
      <TouchableOpacity
        onPress={() => navigation.navigate("(logFood)/LogFood")}
        className="absolute bottom-[138px] right-5 bg-[#ceff00] p-3 rounded-full shadow-lg"
      >
