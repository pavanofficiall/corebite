...
const Workout = () => {
  return (
    <View className="flex-1 justify-end bg-gray-200">
      ...
      <View className="mx-6 my-6 bg-white h-2/4 rounded-2xl">
        {/* Your content here */}
      ...
      <View className="w-full h-96 rounded-3xl flex flex-col justify-start items-center">
        <View className='flex flex-row items-center my-4'>
          <Text className="text-4xl font-semibold px-1 py-3 uppercase">Pushups</Text>
        ...
        <View className='flex-1 flex-row justify-between bottom-0 mt-5 items-center'>
          ...
          <Pressable className="flex flex-row items-center mb-2 py-4 px-14">
            ...
            <Text className="text-xl text-gray-500 uppercase px-1 font-semibold">Previous</Text>
          </Pressable>

          {/* Next Button */}
          <Pressable className="flex flex-row items-center mb-2 py-4 px-14">
            <Text className="text-xl text-gray-500 uppercase px-1 font-semibold">Next</Text>
